...
<body id="body" class="auth-page"
                        ...
                        <div class="col-lg-4 mx-auto">
                            <div class="card">
                                ...
                                <div class="card-body pt-0">
                                    ...
                                    <form id="userLoginForm" class="my-4" action="{{route('user.login')}}" method="post">
                                        @csrf
                                        ...
                                        <div class="form-group mb-0 row">
                                            <div class="col-12">
                                                <div class="d-grid mt-3">
                                                     <button type="submit" id="userLoginSubmit" class="btn btn-primary">
                                                        تسجيل الدخول
    ...
    <script>
        ...
        (function(){
            ...
            if (!form) return;
            const submitBtn = document.getElementById('userLoginSubmit');
