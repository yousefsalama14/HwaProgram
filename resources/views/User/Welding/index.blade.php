                    ...
                    <div class="page-title-box">
                        <div class="float-end">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active">اللحام</li>
                            </ol>
                        </div>
                        <h4 class="page-title">اللحام</h4>
                    </div>
                    <!--end page-title-box-->
                </div>
                <!--end col-->
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="card">
                        ...
                        <form action="{{route('welding.order')}}" method="post">
                            @csrf
                        <!--end card-header-->
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-sm-6 col-lg-4">
                                    <div class="mb-3 row">
                                        <label for="example-number-input"
                                            ...
                                            الباسات :</label>
                                        <div class="col-sm-8 d-flex align-items-center">
                                            <input class="form-control" name="passes" required id="passes" type="number" placeholder="مثال : 1234"
                                                id="example-number-input">
                                            <p class="mb-0 fw-semibold d-none">120 مم</p>
                                        </div>
                                    </div>
                            ...
                            <div class="col-sm-6 col-lg-4">
                                <div class="mb-3 row">
                                    <label for="example-number-input"
                                        ...
                                        الباسات :</label>
                                    <div class="col-sm-8 d-flex align-items-center">
                                        <input class="form-control" name="passes" type="number" placeholder="مثال : 1234" value="{{$detailes->operationdetailes->passes}}" disabled
                                            id="example-number-input">
                                        <p class="mb-0 fw-semibold d-none">120 مم</p>
                                    </div>
                                </div>
